        ...
        <>
            ...
            <main className="relative p-4 md:p-10 lg:p-16 h-auto font-jura">
                ...
                <div className="py-4" id="about">
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'><span className='text-primary'>1.</span> Write something here</span>
                        <p>
                            Write something here...
                        </p>
                    </div>
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>2.</span>  Write something here
                        </span>
                        <p>
                            Write something here...
                        </p>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>3.</span> Write something here
                        </span>
                        <p>
                            Write something here...
                        </p>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>4.</span> Write something here
                        </span>
                        <p>
                            Write soething here...
                        </p>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>5.</span> Write something here
                        </span>
                        <p>
                            Write soething here...
                        </p>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>6.</span> Write something here
                        </span>
                        <p>
                            Write soething here...
                        </p>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>7.</span> Write something
                        </span>
                        <p>
                            Write something here...
                        </p>
