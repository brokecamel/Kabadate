        ...
        <>
            ...
            <main className="relative p-4 md:p-10 lg:p-16 h-auto font-jura">
                <div className="absolute inset-x-0 -top-20 left-32 transform-gpu overflow-hidden blur-3xl sm:-top-60 -z-10" aria-hidden="true">
                    <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[220deg] bg-gradient-to-br from-transparent to-primary opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                ...
                <div className="py-4" id="about">
                    ...
                    <h2 className='text-xl md:text-2xl p-6df] mt-6'>
                        Last updated: <span className='text-primary'>08/01/2024</span>
                    </h2>
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        Write soething here...
                    </div>
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'><span className='text-primary'>1.</span> Write soething here...</span>
                        <p>
                            Write soething here...
                        </p>
                    </div>
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>2.</span> User Conduct
                        </span>
                        <p>
                        Write soething here...:
                        </p>
                        ...
                        <p>
                            <span className='text-primary opacity-80'>(c).</span> Write soething here...
                        </p>
                        <p>
                            <span className='text-primary opacity-80'>(d).</span> Write soething here...
                        </p>
                        <p>
                            <span className='text-primary opacity-80'>(e).</span> Write soething here...
                        </p>
                        <p>
                            <span className='text-primary opacity-80'>(f).</span> Write soething here...
                        </p>
                    </div>
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                    ...
                    <div className='text-xl md:text-2xl p-6df] mt-6'>
                        <span className='font-bold'>
                            <span className='text-primary'>5.</span> Write soething here...
                        </span>
                        <p>
                            Write soething here...
                        </p>
